...
const COPY = {
  fr: {
    ...
    species: { dylan: 'Poméranien', miso: 'Chat', noisette: 'Lapin' },
    intro: {
      ...
      noisette: 'Hop hop ! Moi c’est Noisette. Tout doux, et toujours bien habillé.',
    },
  },
  en: {
    ...
    species: { dylan: 'Pomeranian', miso: 'Cat', noisette: 'Rabbit' },
    intro: {
      dylan: 'Woof! I’m Dylan. One blue eye, one brown, lots of style.',
      miso: 'Meow. Miso. I have an eye for good fabrics.',
      noisette: 'Hop hop! I’m Noisette. Soft, gentle, and always well dressed.',
    },
  },
};
